...
/**
  ...
  *
  * @checksum - 451a10cc30bc53b409a6519e361c933ffe8c384f87f6197f83bf56d9cfaae642
  * @variables - radius=rounded,accentColor=violet,colorTemperature=slate,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listitem": {
    ...
    "dark:aria-selected:text-slate-700": true,
